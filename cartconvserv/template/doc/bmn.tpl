{{define "Back"}}..{{end}}{{define "Payload"}}
  ...
  <h2>Examples</h2>
  <p>
    <a id="osm1" href="#">M34 703168 374510</a> as <a href="{{.APIRoot}}/bmn/M34 703168 374510.json?outputformat=latlongdeg">Lat / Long JSON-encoded</a>,
    as <a href="{{.APIRoot}}/bmn/M34 703168 374510.xml?outputformat=utm">UTM, XML-encoded</a>.
  </p>
  <h2>Reference</h2>
  <p>
